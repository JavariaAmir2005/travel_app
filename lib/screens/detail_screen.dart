                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: Container(
                            ...
                            child: GestureDetector(
                              onTap: () {
                                context.read<BookmarksProvider>().toggleBookmark(location);
                              },
                              child: Icon(
                                Icons.bookmark,
                                size: 30,
                                color: context.watch<BookmarksProvider>().isBookmarked(location) ? Colors.red : Colors.white,
                              ),
                            ),
                          ),
                        ),
                            ...
                            onTap: () {
                              showDialog(
                                ...
                                builder: (context) => AlertDialog(
                                  ...
                                  content: Text('Are you sure you want to book ${location.name}?'),
                                  actions: [
                                    TextButton(
                                    ...
                                    TextButton(
                                      onPressed: () {
                                        ...
                                        ScaffoldMessenger.of(context).showSnackBar(
                                          SnackBar(content: Text('${location.name} booked successfully!')),
                                        );
                                      },
